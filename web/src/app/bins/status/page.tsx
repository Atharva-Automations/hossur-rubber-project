...
export default function BinStatusPage() {
  ...
  if (isLoading) {
    return (
      <DashboardLayout>
        <p className="text-center text-gray-500 mt-10">Loading bin data...</p>
      </DashboardLayout>
    );
  }
                  ...
                  <>
                    ...
                    <div className="pt-3">
                      <Progress
                        ...
                        className={`h-3 ${
                          selectedBin.currentQuantity <= selectedBin.minQuantity
                            ? 'bg-red-200'
                            : selectedBin.currentQuantity >=
                              selectedBin.maxQuantity * 0.9
                            ? 'bg-orange-200'
                            : 'bg-green-200'
                        }`}
                      />
